...
RSpec.describe Redirect do
  context 'at the root folder' do
    let(:redirect) { Redirect.new base_dir: '/Users/dmytroshevtsov/Projects/rubydev/flare-to-jekyll/spec/flare-docs/samples', rel_path: 'catalog-create.htm' }
  ...
  context 'at subfolder and with url starting with slash' do
    let(:redirect) { Redirect.new base_dir: '/Users/dmytroshevtsov/Projects/rubydev/flare-to-jekyll/spec/flare-docs/samples', rel_path: 'catalog/catalog-create.htm' }
